        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    id_do_usuario = table.Column<int>(type: "int", nullable: false),
                    ...
                    desemprego = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ameaca = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    tem_filhos = table.Column<bool>(type: "bit", nullable: false),
                    filhos_tambem_moram_na_rua = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    qual_idade_dos_filhos = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    possui_contato_com_familia_de_origem = table.Column<bool>(type: "bit", nullable: false),
                    quanto_tempo_faz_contato = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    com_quem_tem_contato = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    usou_algum_servico_do_municipio_nos_ultimos_12_meses = table.Column<bool>(type: "bit", nullable: false),
                    qual_servico_usou = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ja_trabalhou_antes_de_morar_na_rua = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    foi_de_carteira_assinada = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    esta_gravida = table.Column<bool>(type: "bit", nullable: false),
                    ja_teve_filhos = table.Column<bool>(type: "bit", nullable: false),
                    tem_problema_de_saude = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    quais_problemas_de_saude = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    faz_tratamento_de_saude = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    toma_medicacao = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    frequenta_alguma_religiao = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    tem_deficiencia = table.Column<bool>(type: "bit", nullable: false),
                    vive_com_a_familia_na_rua = table.Column<bool>(type: "bit", nullable: false),
