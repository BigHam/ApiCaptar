...
namespace apiCaptar.Migrations
{
    ...
    [Migration("20241030114006_ApiCaptarController")]
    partial class ApiCaptarController
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apiCaptar._1_Domain.atendimento", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("atendimentoRealizado")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("atendimentoRealizado");
                    ...
                    b.Property<string>("obsatendimentoRealizado")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("obsatendimentoRealizado");

                    b.Property<string>("observacaoCarro")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("observacaoCarro");

                    b.Property<string>("observacaoHotel")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("observacaoHotel");
                    ...
                    b.Property<string>("valoralmoco")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("valoralmoco");

                    b.Property<string>("valorcafe")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("valorcafe");

                    b.Property<string>("valorhotel")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("valorhotel");

                    b.Property<string>("valorjanta")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("valorjanta");

                    b.HasKey("id");

                    b.ToTable("controleAtendimento");
                });
